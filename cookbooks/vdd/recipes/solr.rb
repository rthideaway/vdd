# Solr Versions:
# The checksum of the version is calculated with the `sha256sum` command on linux, or `shasum -a 256` on Mac.
# If you need to change Solr version then you'll have to update both the checksum and the version number in vdd.json
cores = []
